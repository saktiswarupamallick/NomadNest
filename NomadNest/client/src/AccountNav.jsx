...
export default function AccountNav() {
  ...
  function linkClasses (type=null) {
    let classes = 'inline-flex gap-1 py-2 px-6 rounded-lg transition-colors duration-200';
    if (type === subpage) {
      classes += ' bg-[#F4F1DE] text-black font-medium';
    } else {
      classes += ' bg-black/50 border border-[#F4F1DE]/30 text-[#F4F1DE] hover:bg-[#F4F1DE]/10 backdrop-blur-sm';
    }
    return classes;
  }
  return (
    <nav className="w-full flex justify-center pt-10 gap-2 mb-8">
      ...
      <Link className={linkClasses('experience-bookings')} to={'/account/experience-bookings'}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
